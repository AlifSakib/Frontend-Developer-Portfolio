...
export const Footer: React.FC<FooterProps> = ({ profile }) => {
  ...
  return (
    <footer className="bg-slate-900 text-white py-10 border-t border-slate-800 transition-colors">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 space-y-6">
        {/* Top Row: Sleek Minimal Engagement Micro-Bar */}
        ...
        {/* Bottom Row: Copyright, Version & Social Links */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="p-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition shadow-sm hover:scale-105 active:scale-95 cursor-pointer"
              title="Scroll to Top"
